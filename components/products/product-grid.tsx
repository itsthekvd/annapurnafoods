...
export default function ProductGrid({ products }: ProductGridProps) {
  ...
  // Get selected subscription option details
  const selectedOption = useMemo(() => {
    return subscriptionOptions.find((opt) => opt.id === selectedSubscriptionOption)
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-4 md:p-6 flex-1">
              ...
              <div className="flex items-center mb-2">
                {appliedCoupon ? (
                  <>
                    <span className="text-amber-700 font-bold">₹{discountedPrice.toFixed(2)}</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-sm text-gray-600">
                      {selectedSubscriptionOption !== "one-time" ? (
                        <div>
                          <p className="font-medium text-amber-800">{selectedOption?.name}</p>
        ...
        <CardContent className="p-3">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <Button
              ...
              onClick={() => (product.isSubscription ? setExpandedProductId(product.id) : handleAddToCart(product))}
            >
      ...
      <AnimatePresence>
        {isMobile && lastAddedProduct && recommendations.length > 0 && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">{recommendations.map(renderRecommendationCard)}</div>
          </motion.div>
        )}
      </AnimatePresence>
