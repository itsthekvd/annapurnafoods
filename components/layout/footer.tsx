        ...
        <div className="border-t border-amber-200 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm text-gray-600">
              <Link href="/policies/refund-cancellation" className="hover:text-amber-700">
                Refund & Cancellation Policy
              </Link>
              <Link href="/policies/terms" className="hover:text-amber-700">
                Terms and Conditions
              </Link>
              <Link href="/policies/shipping" className="hover:text-amber-700">
                Shipping Policy
              </Link>
              <Link href="/policies/privacy" className="hover:text-amber-700">
                Privacy Policy
              </Link>
