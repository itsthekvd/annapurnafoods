...
export const metadata: Metadata = {
  title: "Terms and Conditions - Annapurna Foods",
  description: "Terms and conditions for using Annapurna Foods services near Isha Yoga Center Coimbatore.",
}

export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-amber-800 mb-6">Terms and Conditions</h1>
      <div className="prose max-w-none">
        <p className="text-sm text-gray-500 mb-6">Last updated: Oct 02, 2024</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of Annapurna Food's Website, located
          at Annapurna.Food.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use
          Annapurna.Food if you do not agree to take all of the terms and conditions stated on this page.
        </p>
        ...
        <p>
          We employ the use of cookies. By accessing Annapurna.Food, you agreed to use cookies in agreement with the
          Annapurna Food's Privacy Policy.
        </p>
        ...
        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">License</h2>
        <p>
          Unless otherwise stated, Annapurna Food and/or its licensors own the intellectual property rights for all
          material on Annapurna.Food. All intellectual property rights are reserved. You may access this from
          Annapurna.Food for your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className="list-disc pl-6 mb-4">
          <li>Republish material from Annapurna.Food</li>
          <li>Sell, rent or sub-license material from Annapurna.Food</li>
          <li>Reproduce, duplicate or copy material from Annapurna.Food</li>
          <li>Redistribute content from Annapurna.Food</li>
        </ul>

        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Annapurna Food does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of Annapurna Food, its agents and/or
          affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, Annapurna Food shall not be liable for the Comments or for any liability,
        ...
        <p>
          Annapurna Food reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Annapurna Food a non-exclusive license to use, reproduce, edit and authorize others to use,
          reproduce and edit any of your Comments in any and all forms, formats or media.
        </p>

        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">Hyperlinking to our Content</h2>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or
            services; and
          </li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>the benefit to us from the visibility of the hyperlink compensates the absence of Annapurna Food; and</li>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Annapurna Food. Please include your name, your organization name,
        ...
        <p>
          No use of Annapurna Food's logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>

        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">iFrames</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">Content Liability</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">Your Privacy</h2>
        <p>Please read Privacy Policy</p>

        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">Reservation of Rights</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-amber-800 mt-6 mb-3">Removal of links from our website</h2>
        <p>
